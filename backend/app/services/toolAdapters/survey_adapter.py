"""
Adapter scaffold for Survey tool integration.
...
class SurveyAdapter(ToolPort):
    """Fetches tools/options/content from Survey (scaffold)."""

    def list_tools(self) -> List[Dict[str, Any]]:
        return [{"id": "Survey", "name": "Survey"}]
