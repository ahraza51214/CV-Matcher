...
class Settings(BaseSettings):
    # --- App behavior ---
    provider: str = Field(default="ChatGPT", description="Which provider to use (ChatGPT|Gemini|Claude|Fusion)")
    ...
    fusion_judge_provider: str = Field(default="ChatGPT", description="Provider to use as the final judge for the fusion judge step")
